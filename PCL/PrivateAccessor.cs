...
{
    /// <summary>
    ///     A utility class to allow tests to access to private members. For example, accessing private status fields, protected/internal constructors.
    ///     Use with caution, using this private accessor should be the last resort.  Frequent use of this, may indicate design problems.
    /// </summary>
